...
public class LoadingView extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        mShapeLoadingView1 = (ShapeLoadingView) view.findViewById(R.id.shapeLoadingView_1);
        mShapeLoadingView1.setShape(ShapeLoadingView.Shape.SHAPE_CIRCLE);
        mShapeLoadingView2 = (ShapeLoadingView) view.findViewById(R.id.shapeLoadingView_2);
        ...
        mIndicationIm1 = (ImageView) view.findViewById(R.id.indication1);
        mIndicationIm2 = (ImageView) view.findViewById(R.id.indication2);
