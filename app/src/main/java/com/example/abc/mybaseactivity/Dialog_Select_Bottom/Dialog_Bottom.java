package com.example.abc.mybaseactivity.Dialog_Select_Bottom;
 ...
 */
public class Dialog_Bottom extends Dialog implements OnClickListener {
    /* 控件的id */
    ...
    public Dialog_Bottom(Context context) {
     ...
     * @return
     */
    public Dialog_Bottom setCancelButtonTitle(String title) {
     ...
     * @return
     */
    public Dialog_Bottom setCancelButtonTitle(int strId) {
     ...
     * @return
     */
    public Dialog_Bottom setCancelableOnTouchMenuOutside(boolean cancelable) {
        mCancelableOnTouchOutside = cancelable;
        return this;
    }

    public Dialog_Bottom addItems(String... titles) {
    ...
    public Dialog_Bottom setItemClickListener(MenuItemClickListener listener) {
